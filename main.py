...
from for_main import second
from for_main import second_2
...
1. 偵測日期提供諺語.py - 陶芷鈺
2. 功能查詢與諺語查詢.py、bear.py - 陳湘雯
3. 測驗程式.ipynb - 鄭程遠 (無法使用)
...
# 功能查詢與諺語查詢 陳湘雯
while 1: # 需要讓程式一直執行，回到選單。使用 while 迴圈
    print("請參考菜單，選擇您需要的功能")
    bear.menu()
    choose=input("請輸入選項[1/2/3]：")
